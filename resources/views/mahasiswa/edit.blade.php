        ...
        <div class="card" style="width: 24rem;">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="Foto_mahasiswa" class="form-control-file" value="{{ $Mahasiswa->foto_mahasiswa }}" accept = 'image/jpeg , image/jpg, image/gif, image/png' id="Foto_mahasiswa">
                </div>
                <div class="form-group">
